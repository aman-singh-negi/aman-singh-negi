...
### Software Developer · AI/ML Engineer · Competitive Programmer
...
I'm a Computer Science Engineering student focused on **software development, problem solving, and AI/ML**.

I enjoy building practical software, solving algorithmic problems, and understanding the engineering decisions behind the systems I build.
...
`NumPy` · `Pandas` · `Scikit-learn` · `Matplotlib` · `MediaPipe` · `Jupyter`
...
|  🟫 **CodeChef**  | [@amansinghnegi0](https://www.codechef.com/users/amansinghnegi0) · **3★** |
